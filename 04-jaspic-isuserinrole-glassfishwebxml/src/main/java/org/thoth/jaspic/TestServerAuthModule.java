...
public class TestServerAuthModule implements ServerAuthModule {
    ...
    public AuthStatus validateRequest(MessageInfo messageInfo, Subject clientSubject, Subject serviceSubject) throws AuthException {
        ...
        if (groups != null) {
            authenticateUser(groups, clientSubject, serviceSubject);
        }
    ...
    private void authenticateUser(String groups, Subject clientSubject, Subject serverSubject)
    {
        log.info(String.format("Creating Principal for groups=\"%s\"", groups));

        CallerPrincipalCallback callerPrincipalCallback
            = new CallerPrincipalCallback(clientSubject, "04-jaspic-isuserinrole-glassfishwebxml-usr");
