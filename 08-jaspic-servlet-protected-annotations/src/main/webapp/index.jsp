...
<html>
    ...
    <body>
        ...
        <ul>
            ...
            <% q1 += " another servlet that's private which is accessible only by a specific"; %>  
            <% q1 += " identity management group?"; %> 
            <% q1 += " Everything is declared in annotations except for the"; %> 
            <% q1 += " identity-management groups in and glassfish-web.xml."; %> 
