...
import org.thoth.jaspic.customprincipal.lang.MyReflectionToStringBuilder;
import org.thoth.jaspic.customprincipal.security.MyPrincipal;

/**
 *
 * @author Michael Remijan mjremijan@yahoo.com @mjremijan
 */
public class MyCallbackBuilder {

    private static final Logger log = Logger.getLogger(MyCallbackBuilder.class);
    ...
    public MyCallbackBuilder(MessageInfo messageInfo, Subject clientSubject) {
    ...
    public Callback[] build() {
        ...
        if (callback == null) {
            ...
            if (groups != null) {
                ...
                MyPrincipal myp
                    = new MyPrincipal(username, Arrays.asList(groups.split(",")));

                callback = new Callback[]{
                      new CallerPrincipalCallback(clientSubject, myp)
