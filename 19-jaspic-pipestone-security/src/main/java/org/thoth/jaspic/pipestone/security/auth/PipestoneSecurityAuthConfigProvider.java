...
public class PipestoneSecurityAuthConfigProvider implements AuthConfigProvider {

    private static final String CALLBACK_HANDLER_PROPERTY_NAME = "authconfigprovider.client.callbackhandler";

    private Map<String, String> providerProperties;

    public PipestoneSecurityAuthConfigProvider() {
    }
     ...
     * @param factory
     */
    public PipestoneSecurityAuthConfigProvider(Map<String, String> properties,
    ...
    public ServerAuthConfig getServerAuthConfig(String layer,
        ...
        return new PipestoneSecurityServerAuthConfig(layer, appContext,
