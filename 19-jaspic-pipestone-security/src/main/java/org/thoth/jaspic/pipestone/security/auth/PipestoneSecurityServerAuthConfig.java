...
public class PipestoneSecurityServerAuthConfig implements ServerAuthConfig {
    ...
    public PipestoneSecurityServerAuthConfig(String layer, String appContext,
    ...
    public ServerAuthContext getAuthContext(String authContextID,
        ...
        return new PipestoneSecurityServerAuthContext(handler);
    }
