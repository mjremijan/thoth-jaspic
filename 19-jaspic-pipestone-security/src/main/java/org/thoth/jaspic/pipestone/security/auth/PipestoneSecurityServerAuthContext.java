...
public class PipestoneSecurityServerAuthContext implements ServerAuthContext {

    private ServerAuthModule serverAuthModule;

    public PipestoneSecurityServerAuthContext(CallbackHandler handler) throws AuthException {
        serverAuthModule = new PipestoneSecurityServerAuthModule();
