...
public class PipestoneSecurityServerAuthModule implements ServerAuthModule {

    private static final Logger log = Logger.getLogger(PipestoneSecurityServerAuthModule.class);
    ...
    public AuthStatus validateRequest(MessageInfo messageInfo, Subject clientSubject, Subject serviceSubject) throws AuthException {
        ...
        // *********************************************************************
        Callback[] callback
            = new PipestoneSecurityCallbackBuilder(messageInfo,clientSubject).build();
