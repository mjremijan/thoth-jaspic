...
import org.thoth.jaspic.lang.MyReflectionToStringBuilder;
import org.thoth.jaspic.security.group.GroupFinder;
...
public class TestCallbackBuilder {
    ...
    public TestCallbackBuilder(MessageInfo messageInfo, Subject clientSubject) {
    ...
    public Callback[] build() {
        ...
        if (callback == null) {
            ...
            GroupFinder finder 
                = CDI.current().select(GroupFinder.class).get();
            log.info(String.format("Got GroupFinder \"%s\"", String.valueOf(finder)));
            
            String username = "thoth-jaspic-usr";
            String groups = finder.findGroups(username);
